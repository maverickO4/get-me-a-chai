...
const Login = () => {
  ...
  return (
    <div className="text-white py-14 container mx-auto">
      <h1 className="font-bold text-3xl text-center">Login/Signup to start</h1>

      <div className="flex flex-col gap-2 min-h-screen items-center p-10">
        <button className="flex items-center text-black w-64 bg-slate-200 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
        ...
        <button
          className="flex items-center text-black w-64 bg-slate-200 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
          onClick={() => {
            signIn("github");
          }}
        >
